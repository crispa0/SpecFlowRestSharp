...
namespace SpecFlowRestSharp.StepDefinitions
{
    ...
    public sealed class PATCHStepDefinitions
    {
        ...
        [Then("the Status Code from PATCH call should be (.*)")]
        ...
        [Then(@"the updated payload after PATCH call should be ""([^""]*)"" ""([^""]*)""")]
